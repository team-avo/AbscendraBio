...
export default function CancelledOrdersPage() {
  ...
  const handleExportAll = async () => {
    ...
    try {
      ...
      toast.error('Failed to export cancelled orders');
      throw e;
    }
  };
      ...
      <DashboardLayout>
        <div className="space-y-5 px-2 sm:px-0">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h1 className="text-2xl font-bold tracking-tight text-slate-900">Cancelled Orders</h1>
              <p className="text-sm text-slate-500 mt-0.5">Orders that were cancelled or refunded</p>
            </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden">
            <div className="px-6 py-4 border-b border-slate-100 flex items-center gap-3">
              ...
              <div>
                <h2 className="text-sm font-semibold text-slate-800">Cancelled Orders</h2>
          ...
          <SendReportDialog
            ...
            title="Send Cancelled Orders Report"
            description="Enter the email address where you want to receive the cancelled orders report."
          />
        </div>
      </DashboardLayout>
    </ProtectedRoute>
