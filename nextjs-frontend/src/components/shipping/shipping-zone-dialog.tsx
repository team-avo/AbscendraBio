      ...
      <DialogContent className="max-w-2xl max-h-[80vh] p-0 rounded-2xl overflow-hidden border-gray-200 flex flex-col">
        <div className="bg-[#043061] px-6 py-5 relative overflow-hidden flex-shrink-0">
          ...
          <div className="flex items-center gap-3 relative z-10">
            ...
            <div>
              <DialogTitle className="text-base font-bold text-white">Shipping Zone</DialogTitle>
              <p className="text-xs text-white/50 mt-0.5">{zone ? "Edit shipping zone details" : "Create a new shipping zone"}</p>
            </div>
          </div>
        </div>
