    ...
    <div className={`min-h-screen bg-white ${barlow.className}`}>
      <div className="max-w-3xl mx-auto px-6 py-20">
        ...
        <div className="prose prose-sm max-w-none text-gray-700 space-y-8">
          ...
          <section>
            <h2 className="text-lg font-bold text-[#070B14] mb-3">3. Information Sharing</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-bold text-[#070B14] mb-3">4. Data Security</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-bold text-[#070B14] mb-3">5. Cookies</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-bold text-[#070B14] mb-3">6. Your Rights</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-bold text-[#070B14] mb-3">7. Contact Us</h2>
            <p className="leading-relaxed">
