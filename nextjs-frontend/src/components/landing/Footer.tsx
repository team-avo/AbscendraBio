          ...
          <div>
            ...
            <div className="bg-white/[0.03] border border-white/[0.06] rounded-xl p-5">
              <p className="text-sm text-gray-400 leading-relaxed">
                Products are intended for <strong className="text-gray-200">professional use only</strong>. Not for human consumption. Use exclusively in laboratory or clinical research settings by licensed researchers.
              </p>
            </div>
          </div>
      ...
      <div className="border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col sm:flex-row justify-between items-center gap-3">
          ...
          <div className="flex items-center gap-5">
            <Link href="/landing/privacy" className="text-[11px] text-gray-600 hover:text-gray-400 transition-colors">Privacy</Link>
            <Link href="/landing/terms" className="text-[11px] text-gray-600 hover:text-gray-400 transition-colors">Terms</Link>
          </div>
        </div>
      </div>
    </footer>
