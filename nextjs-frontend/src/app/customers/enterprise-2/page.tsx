        ...
        <div className="space-y-5 px-2 sm:px-0">
          ...
          <div className="relative bg-[#070B14] rounded-2xl mx-1 sm:mx-0 overflow-hidden">
            ...
            <div className="relative z-10 px-6 py-6 sm:px-8 sm:py-7">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                  <h1 className="text-2xl font-black text-white tracking-tight">Enterprise Tier 2 Customers</h1>
                  <p className="text-xs text-white/40 mt-1">Manage and oversee your Enterprise Tier 2 customer accounts</p>
                </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden">
            <div className="px-6 py-4 border-b border-slate-100 flex items-center gap-3">
              ...
              <div>
                <h2 className="text-sm font-semibold text-slate-800">Enterprise 2 Customers List</h2>
