  ...
  return (
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto w-[calc(100vw-2rem)] sm:w-full p-0 rounded-2xl overflow-hidden border-gray-200">
          <div className="bg-[#1B2D4F] px-6 py-5 relative overflow-hidden flex-shrink-0">
            ...
            <div className="flex items-center gap-3 relative z-10">
              ...
              <div>
                <DialogTitle className="text-base font-bold text-white">Customer Address</DialogTitle>
                <p className="text-xs text-white/50 mt-0.5">Manage billing and shipping addresses</p>
              </div>
            </div>
          </div>
