...
export function OrderSummaryDialog({ order, open, onClose }: OrderSummaryDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-5xl w-[95vw] max-h-[95vh] overflow-hidden flex flex-col p-0 rounded-2xl overflow-hidden border-gray-200">
        <div className="bg-[#043061] px-6 py-5 relative overflow-hidden flex-shrink-0">
          ...
          <div className="flex items-center gap-3 relative z-10">
            ...
            <div>
              <DialogTitle className="text-base font-bold text-white">Order Summary</DialogTitle>
              <p className="text-xs text-white/50 mt-0.5">Overview of order #{order.orderNumber}</p>
            </div>
          </div>
        </div>
