                ...
                <div className="relative z-10 px-6 py-6 sm:px-8 sm:py-7">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div>
                            ...
                            <h1 className="text-xl font-black text-[#043061] tracking-tight">Payments</h1>
                        ...
                        <div className="flex items-center gap-2.5 flex-wrap">
                            <div className="flex items-center gap-2.5 bg-white border border-line rounded-xl px-4 py-2">
                                <DollarSign className="h-4 w-4 text-[#5A9ADA]" />
                                <div>
                                    <p className="text-[9px] text-gray-500 font-medium uppercase tracking-widest leading-none">Revenue</p>
                                    <p className="text-base font-black text-[#043061] tabular-nums leading-tight">${totalRevenue.toLocaleString()}</p>
                                </div>
                            </div>
                            <Button
                                onClick={() => setRecordDialogOpen(true)}
                                className="h-9 px-5 bg-[#043061] text-white hover:bg-[#0b4f96] rounded-xl text-xs font-black uppercase tracking-widest self-start sm:self-auto"
                            >
