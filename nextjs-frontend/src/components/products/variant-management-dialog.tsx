  ...
  return (
    <>
      <Dialog open={open && !showVariantForm} onOpenChange={onOpenChange}>
        <DialogContent className="w-[95vw] sm:max-w-4xl max-h-[95vh] sm:max-h-[90vh] overflow-y-auto p-0 rounded-2xl overflow-hidden border-gray-200">
          <div className="bg-[#043061] px-6 py-5 relative overflow-hidden flex-shrink-0">
            ...
            <div className="flex items-center gap-3 relative z-10">
              ...
              <div>
                <DialogTitle className="text-base font-bold text-white">Manage Variants</DialogTitle>
                <p className="text-xs text-white/50 mt-0.5">Add, edit, or remove product variants</p>
              </div>
            </div>
          </div>
