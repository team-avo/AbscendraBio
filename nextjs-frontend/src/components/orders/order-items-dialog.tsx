...
export function OrderItemsDialog({ order, open, onClose }: OrderItemsDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-7xl w-[95vw] max-h-[95vh] overflow-hidden flex flex-col p-0 rounded-2xl overflow-hidden border-gray-200">
        <div className="bg-[#1B2D4F] px-6 py-5 relative overflow-hidden flex-shrink-0">
          ...
          <div className="flex items-center gap-3 relative z-10">
            ...
            <div>
              <DialogTitle className="text-base font-bold text-white">Order Items</DialogTitle>
              <p className="text-xs text-white/50 mt-0.5">All items in this order</p>
            </div>
          </div>
        </div>
