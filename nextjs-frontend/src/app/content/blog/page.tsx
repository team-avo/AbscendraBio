    ...
    <ProtectedRoute requiredRoles={["ADMIN", "MANAGER", "STAFF"]}>
      <DashboardLayout>
        <div className="space-y-0 px-2 sm:px-0">
          {/* Dark Hero Strip */}
          <div className="relative bg-mist border border-line border-t-2 border-t-[#5A9ADA] rounded-2xl mx-1 sm:mx-0 overflow-hidden mb-5">
            ...
            <div className="relative z-10 px-6 py-6 sm:px-8 sm:py-7">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                  <h1 className="text-xl font-black text-[#043061] tracking-tight">Blog</h1>
                  <p className="text-xs text-gray-500 mt-0.5">Manage blog posts</p>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-xs text-gray-400 bg-white/10 px-2.5 py-1 rounded-lg font-medium">{rows.length} posts</span>
                  <button onClick={() => router.push('/content/blog/new')} className="flex items-center gap-1.5 h-9 px-4 bg-[#043061] text-white rounded-xl text-xs font-black uppercase tracking-widest hover:bg-gray-100 transition-colors">
