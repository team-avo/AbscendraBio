...
export default function FailedPaymentsOrdersPage() {
  ...
  const handleExportAll = async () => {
    ...
    try {
      ...
      toast.error('Failed to export failed-payment orders');
      throw e;
    }
  };
      ...
      <DashboardLayout>
        <div className="space-y-0">
            ...
            <div className="relative z-10 px-6 py-6 sm:px-8">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h1 className="text-xl font-black text-[#043061] tracking-tight">Failed Payments Orders</h1>
          ...
          <SendReportDialog
            ...
            title="Send Failed Payments Report"
            description="Enter the email address where you want to receive the failed payments report."
          />
        </div>
      </DashboardLayout>
    </ProtectedRoute>
