      ...
      <DashboardLayout>
        <div className="space-y-5 px-2 sm:px-0">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h1 className="text-2xl font-bold tracking-tight text-slate-900">Tier 1 Customers</h1>
              <p className="text-sm text-slate-500 mt-0.5">Manage your Tier 1 (Consumer) customers</p>
            </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden">
            <div className="px-6 py-4 border-b border-slate-100 flex items-center gap-3">
              ...
              <div>
                <h2 className="text-sm font-semibold text-slate-800">Tier 1 Customers List</h2>
