  ...
  return (
    <div className={`min-h-screen bg-white ${barlow.className}`}>
      <div className="max-w-3xl mx-auto px-6 py-20">
        ...
        <h1 className="text-4xl font-black tracking-tight text-[#043061] mb-2">Privacy Policy</h1>
        <p className="text-sm text-gray-400 mb-10">Last updated: June 26, 2026</p>

        <div className="prose prose-sm max-w-none text-gray-700 space-y-8">
          <section>
            <h2 className="text-lg font-bold text-[#043061] mb-3">1. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#043061] mb-3">2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#043061] mb-3">3. SMS / Text Message Communications</h2>
            <p className="leading-relaxed">
            ...
            <p className="leading-relaxed mt-3">
              ...
              <Link href="/landing/terms" className="text-[#5A9ADA] hover:underline">Terms of Service</Link>.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-[#043061] mb-3">4. Information Sharing</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-bold text-[#043061] mb-3">5. Data Security</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-bold text-[#043061] mb-3">6. Cookies</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-bold text-[#043061] mb-3">7. Your Rights</h2>
            <p className="leading-relaxed">
              ...
              <a href="mailto:privacy@ascendrabio.com" className="text-[#5A9ADA] hover:underline">
          ...
          <section>
            <h2 className="text-lg font-bold text-[#043061] mb-3">8. Contact Us</h2>
            <p className="leading-relaxed">
