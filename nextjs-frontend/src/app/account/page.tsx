        ...
        <div className="relative bg-mist border border-line border-t-2 border-t-[#5A9ADA] rounded-2xl mx-1 sm:mx-0 overflow-hidden">
          ...
          <div className="relative z-10 px-6 py-6 sm:px-8 sm:py-7">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                <h1 className="text-2xl font-black text-[#043061] tracking-tight">MY ACCOUNT</h1>
                <p className="text-xs text-[#6b7d93] mt-1">Manage your profile and orders</p>
              </div>
              <div className="flex items-center gap-2">
                <Link href="/account/orders" className="inline-flex items-center gap-1.5 bg-white border border-line rounded-xl px-4 py-2 text-xs font-medium text-[#043061] hover:bg-mist-2 transition-all">
                  View Orders
                </Link>
                <Link href="/account/favorites" className="inline-flex items-center gap-1.5 bg-[#5A9ADA] hover:bg-[#0b4f96] rounded-xl px-4 py-2 text-xs font-semibold text-white transition-all">
                  Favorites
                </Link>
              </div>
            </div>
          ...
          <div className="relative bg-white rounded-2xl border border-gray-200/80 shadow-sm p-6">
            ...
            {loading ? (
              ...
              <div className="flex items-start gap-4">
                {/* Avatar */}
                <div className="w-12 h-12 rounded-full bg-[#043061] flex items-center justify-center shrink-0">
                ...
                <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2 text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-[#043061] mt-0.5">{totalOrders}</p>
                  </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200/80 shadow-sm p-6 lg:col-span-2">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex gap-2">
                ...
                <Link href="/account/orders" className="inline-flex items-center bg-[#043061] hover:bg-[#0b4f96] text-white rounded-xl px-3 py-1.5 text-xs font-semibold transition-all">View Orders</Link>
              </div>
            </div>
        ...
        <div className="mt-8">
          <div className="bg-white rounded-2xl border border-gray-200/80 shadow-sm p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <button className="inline-flex items-center bg-[#043061] hover:bg-[#0b4f96] text-white rounded-xl px-3 py-1.5 text-xs font-semibold transition-all" onClick={() => {
                setEditingAddressId(null);
                setAddressForm({
                  type: 'SHIPPING',
                  firstName: customer?.firstName || profile.firstName || '',
