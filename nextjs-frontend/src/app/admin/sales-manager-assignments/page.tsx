        ...
        <ProtectedRoute requiredRoles={['ADMIN']}>
            <DashboardLayout>
                <div className="space-y-0">
                    ...
                    <div className="relative bg-mist border border-line border-t-2 border-t-[#5A9ADA] rounded-2xl mx-1 sm:mx-0 overflow-hidden">
                        ...
                        <div className="relative z-10 px-6 py-6 sm:px-8 sm:py-7">
                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                                <div>
                                    <h1 className="text-xl font-black text-[#043061] tracking-tight">Assign Customers to Sales Managers</h1>
                                    <p className="text-xs text-gray-500 mt-0.5">Map customers to sales manager portfolios</p>
                                </div>
                                <div className="flex items-center gap-2.5 bg-white border border-line rounded-xl px-4 py-2">
                                    ...
                                    <div>
                                        <p className="text-[9px] text-gray-500 font-medium uppercase tracking-widest leading-none">Managers</p>
                                        <p className="text-base font-black text-[#043061] tabular-nums leading-tight">{managers.length}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-white rounded-2xl border border-gray-200/80 shadow-sm overflow-hidden mt-4 mx-1 sm:mx-0">
