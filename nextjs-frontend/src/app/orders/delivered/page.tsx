...
export default function DeliveredOrdersPage() {
  ...
  const handleExportAll = async () => {
    ...
    try {
      ...
      toast.error('Failed to export delivered orders');
      throw e;
    }
  };
        ...
        <div className="space-y-5 px-2 sm:px-0">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="text-sm text-slate-500 mt-0.5">Orders successfully received by customers</p>
            </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden">
            <div className="px-6 py-4 border-b border-slate-100 flex items-center gap-3">
              ...
              <div>
                <h2 className="text-sm font-semibold text-slate-800">Delivered Orders</h2>
          ...
          <SendReportDialog
            ...
            title="Send Delivered Orders Report"
            description="Enter the email address where you want to receive the delivered orders report."
          />
        </div>
      </DashboardLayout>
    </ProtectedRoute>
