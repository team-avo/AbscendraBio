          ...
          <div className="relative bg-mist border border-line border-t-2 border-t-[#5A9ADA] rounded-2xl mx-1 sm:mx-0 overflow-hidden">
            ...
            <div className="relative z-10 px-6 py-6 sm:px-8 sm:py-7">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                  <h1 className="text-2xl font-black text-[#043061] tracking-tight">Enterprise Tier 2 Customers</h1>
                  <p className="text-xs text-[#6b7d93] mt-1">Manage and oversee your Enterprise Tier 2 customer accounts</p>
                </div>
